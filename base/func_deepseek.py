...
class DeepSeek():
    ...
    def get_summary1(self, messages, roomid):
        ...
        summary_prompt = (
                ...
                "请帮我将给出的群聊内容总结成群聊报告，请你一步步思考,包含不多于10个的话题的总结(要判定Json内容和你生成话题数要对应，不要自行生成多余的话题)（如果还有更多话题，可以在后面简单补充）。每个话题包含以下内容："
                ...
                "5. 开始给出本群讨论风格的整体评价，例如本群讨论很活跃哦！、本群无关话题太多了好水鸭、此群好像话题不集中呢、本群的话题有些无聊呢等等诸如此类,最好加点俏皮语气词(要求以一个话题专家狲狲口吻回答)"
