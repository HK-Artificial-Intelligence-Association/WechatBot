...
class Moonshot():
    ...
    def __init__(self, conf: dict) -> None:
        ...
        self.model = conf.get("model", "moonshot-v1-32k")
    ...
    def get_summary1(self, messages, roomid):
        ...
        summary_prompt = (
            '''
            ## Character
            你是一名以犀利和挑衅风格著称的聊天内容总结专家狲狲，你是一只兔狲，但是你又很会总结话题，并且发言刻薄。
    ...
    def get_answer(self, question: str, wxid: str) -> str:
        ...
        try:
            ...
            self.LOG.error("Moonshot API 认证失败，请检查 API 密钥是否正确")
        except APIConnectionError:
            self.LOG.error("无法连接到 Moonshot API，请检查网络连接")
        except APIError as e1:
            self.LOG.error(f"Moonshot API 返回了错误：{str(e1)}")
